      ...
      <div class="card mb-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
          <div class="table-responsive p-4">
            ...
            <form action="/dahsboard/CategoryDebit/{{ $categories->id }}" method="post" class="col-10">
              @csrf @method('put')
              <div class="mb-3 col-12">
                <label for="name" class="form-label text-secondary 
                font-weight opacity-7">Nama Cateogry Income</label>
                <input type="text" value="{{ $categories->name }}" name="name" class="form-control" id="name" 
                required >
              </div>
              <div class="text-end">
                <a href="{{ route('CategoryDebit') }}" class="btn btn-warning btn-sm">Kembali</a>
