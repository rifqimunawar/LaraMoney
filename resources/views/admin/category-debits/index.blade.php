@section('title') {{ 'Category Income' }}@endsection
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
          <h5>Data Category Uang Masuk</h5>
          <a href="{{ route('CategoryDebit.create') }}" class="btn btn-primary btn-xs">Tambah Category</a>
                    ...
                    <tr>
                        ...
                        <td class="text-center text-xs">
                            <form action="/dahsboard/CategoryDebit/{{ $category->id }}" method="POST">
                                ...
                                {{ $category->id }}/edit"><i class="fas fa-pencil-alt text-dark me-2" aria-hidden="true">
                                  </i>Edit</a>
                                @csrf
                                @method('DELETE')
