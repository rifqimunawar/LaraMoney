@section('title') {{ 'Edit Cost' }}@endsection
    ...
    <div class="col-12">
      <div class="card mb-4">
        <div class="card-header pb-0">
          <h5>Edit Uang Keluar</h5>
        </div>
        <div class="card-body px-0 pt-0 pb-2">
          <div class="table-responsive p-4">
            
            <form action="/dahsboard/kredit/{{ $kredit->id }}" method="post" class="col-10">
              @csrf @method('put')
              <div class="mb-3 col-12">
                ...
                required oninput="formatRupiah(this)" value="{{ $kredit->rp }}">
              </div>
              ...
              <div class="mb-3 col-12">
                ...
                <select class="form-select" name="category_id" aria-label="Default select example">
                  ...
                  <option value="{{ $category->id }}" 
                      {{ $kredit->category_id == $category->id ? 'selected' : '' }}>
                      {{ $category->name }}
                    </option>
                @endforeach
                </select>
              ...
              <div class="mb-3 col-12">
                ...
                <textarea class="form-control" name="description" id="description" rows="3">
                  {{ $kredit->description }}</textarea>
            </div>
            

              <div class="text-end">
                <a href="{{ route('kredit') }}" class="btn btn-warning btn-sm">Kembali</a>
